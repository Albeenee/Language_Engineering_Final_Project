...
if __name__=='__main__':
    ...
    parser.add_argument('-sl', '--sentence_length', type=int,default=7, help='Number of epochs')
    ...
    parser.add_argument( '-l', '--load', default='project_language_engineering/rnn_model',type=str,help="The directory with encoder and decoder models to load")
#default= 'project_language_engineering/model_2023-05-24_19_30_34_147091',
    ...
    if args.load:
        ...
        for epoch in range( args.epochs ) :
            total_loss = 0
            for source, target in tqdm(training_loader, desc="Epoch {}".format(epoch + 1)): #tqdm(training_loader, desc="Epoch {}".format(epoch + 1)):
